...
export default function Home() {
    return (
        <div className="wood bg-paper text-wood">
            <div className="flex flex-col items-center">
                <Header></Header>
                <div className="z-1 relative mb-20 shadow-2xl shadow-black">
                    ...
                    <main className="paper rounded-xl max-w-5xl text-gray-900 px-8 border-paper-solid flex flex-col gap-8 py-8 shadow-lg shadow-black">
